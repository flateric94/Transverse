...
def write_csv(matrix_color):
    with open("matrix_to_compare.csv", "w") as file:
        ...
        #shutil.move(sc.chemin+'/matrix_to_compare.csv', sc.path+"/Resultats/matrix_to_compare.csv")
    file.close()
    
    
def rmsd(pdb1,pdb2,chaineA,chaineB):
    rmsd=0
    matrix_distance,matrix_square_distance=mc.distance(pdb1,pdb2,chaineA,chaineB)
    #print(matrix_distance)
    #matrix1,matrix_color1=best_pairs_l_r(matrix_distance)
    #print(matrix1)
    #print("rrrrrrrrrrrrrrrr")
    matrix,matrix_color2=best_pairs_r_l(matrix_distance)
    print(matrix)
...
def main():
    ...
    #pdb1 = "C:\\Users\\tanvi\\Documents\\EIDD\\Projet_transverse\\Fichier_pdb\\1e1v.pdb"
    pdb1 = sc.user_input1
    #pdb2 = "C:\\Users\\tanvi\\Documents\\EIDD\\Projet_transverse\\Fichier_pdb\\3fh7.pdb"
    pdb_dali = sc.path+"/Resultats/Resultat_DaliLite/"+sc.nom_result_dali+".pdb"
    #pdb3="C:\\Users\\tanvi\\Documents\\EIDD\\Projet_transverse\\Comparaison 3fts-3fh7\\via TM_Align\\TM.sup_all_atm.pdb"
    pdb_tma = sc.path+"/Resultats/Resultat_TMalign/"+sc.nom_result_dali+".pdb"
    #pdb4="C:\\Users\\tanvi\\Documents\\EIDD\\Projet_transverse\\sup.pdb"
    print(rmsd(pdb1,pdb_dali))
    shutil.move(sc.chemin+'/matrix_1.csv', sc.path+"/Resultats/matrix_1.csv")
    ...
    #matrix=[['x',11,12,13,14,15,16],[21,2,0,2,2,2,2],[22,3,1,2,0,2,2],[23,2,2,0,1,2,2],[24,2,0,2,2,2,2]]
    #matrix1=[['x',11,12,13,14,15,16],[21,0,2,2,2,2,2],[22,3,0,2,2,2,2],[23,2,2,0,1,2,2],[24,2,2,2,0,2,2]]
    #pdb1 = "C:\\Users\\tanvi\\Documents\\EIDD\\Projet_transverse\\Fichier_pdb\\3fts.pdb"
    pdb1 = "/home/administrateur/Bureau/pdb_doc/3fh7.pdb"
    #pdb2 = "C:\\Users\\tanvi\\Documents\\EIDD\\Projet_transverse\\Fichier_pdb\\Essai4.pdb"
    ...
    pdb4 = "/home/administrateur/Bureau/transverse/Resultats/Resultat_DaliLite/3fh7_vs_3fts_dali.pdb"
    print(rmsd(pdb1,pdb4,"A","A"))
